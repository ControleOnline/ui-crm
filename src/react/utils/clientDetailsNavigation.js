/**
 * Pure helper: resolves safe CRM → ClientDetails navigation.
 * Ensures clientId is present, sets contextKey=client, and opens
 * sellers tab for legal entities (PJ / peopleType J).
 */
